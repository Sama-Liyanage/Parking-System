...
public class ParkingSystemFormController {
    ...
    public void initialize() {
        ...
        InParkingVehicleController.driverNameArrayList = driverList;
        InParkingVehicleController.parkArrayList = parkList;
    }
    ...
    private int checkOnDeliverList() {
        int i = 0;
        for (DriverName t1 : driverList) {
            if (cmbSelectVehicle.getValue().equals(t1.getVehicleNumber())) {
                i = 1;
            }
        }
        return i;
